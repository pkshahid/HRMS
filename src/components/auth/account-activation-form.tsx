...
export function AccountActivationForm({ token }: { token: string }) {
  ...
  return (
    <div className="card p-5 sm:p-7">
      <h2 className="text-base font-semibold text-ink-900 sm:text-lg">Activate your account</h2>
      <p className="mt-1 text-sm text-ink-500">Set your password to activate your account.</p>
